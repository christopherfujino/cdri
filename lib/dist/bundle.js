...
var getInput = function getInput(chunk) {
  var string = chunkToString$1(chunk).toLowerCase();
...
var chunkToString$1 = function chunkToString$1(chunk) {
  var string = '' + chunk;
  return string.split('\n')[0];
};

var yesOrNo = function yesOrNo(cb) {
  // yesOrNo()
  callback = cb;
